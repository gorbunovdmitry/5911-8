...
function renderCalculator() {
  ...
  if (typeof gtag === 'function') {
    gtag('event', '5911_page_view_choose_loan_var8');
  }
  sendYMEvent('5911_page_view_choose_loan_var8');
  app.innerHTML = `
  ...
  document.getElementById('nextBtn').addEventListener('click', () => {
    if (typeof gtag === 'function') {
      gtag('event', '5911_click_continue_var8');
    }
    sendYMEvent('5911_click_continue_var8');
...
function renderConfirm() {
  ...
  setTimeout(() => {
    if (typeof gtag === 'function') {
      gtag('event', '5911_page_view_agreement_var8');
    }
    sendYMEvent('5911_page_view_agreement_var8');
  }, 0);
  ...
  document.getElementById('submitBtn').addEventListener('click', () => {
    ...
    if (typeof gtag === 'function') {
      gtag('event', '5911_click_agreement_make_deal_var8', params);
    }
    sendYMEvent('5911_click_agreement_make_deal_var8', params);
...
function renderSuccess() {
  ...
  if (typeof gtag === 'function') {
    gtag('event', '5911_end_page_view_var8');
  }
  sendYMEvent('5911_end_page_view_var8');
}
